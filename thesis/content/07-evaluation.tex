...
This chapter evaluates Intent-Conditioned Value Projection as a decision model for the Internet of Value. The empirical question is the one posed in RQ3 of Chapter \ref{sec:aims}. To what extent does ICVP improve decision quality, evidence relevance, and auditability across NFT, productive-asset, and treasury-governance scenarios, when compared with single-dimensional and fixed-weight valuation baselines? The chapter is therefore organised around framework validation rather than around a comparison between commercial language models. Model choice is held fixed across configurations within each task and is treated as a configuration variable rather than as the object of study.
