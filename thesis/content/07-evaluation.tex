...
\begin{table}[h]
\centering
\caption[Preliminary decision quality on the Pudgy Penguin regime]{Preliminary decision quality on the Pudgy Penguin regime. Component MAE is the mean absolute error of $A/D/U$ scores against the expert median across the four tasks. Numbers are subject to revision after the full benchmark rerun.}
...
\begin{table}[h]
\centering
\caption[Preliminary evidence relevance and trace quality on the Pudgy Penguin regime]{Preliminary evidence relevance and trace quality on the Pudgy Penguin regime. Numbers are subject to revision after the full benchmark rerun.}
\label{tab:nft-trace}
\begin{tabular}{|l|c|c|c|c|}
\hline
...
\begin{table}[h]
\centering
\caption[Preliminary decision quality on the stETH regime]{Preliminary decision quality on the stETH regime. Numbers are subject to revision after the full benchmark rerun.}
...
\begin{table}[h]
\centering
\caption[Preliminary decision quality on the Polkadot OpenGov regime]{Preliminary decision quality on the Polkadot OpenGov regime. Numbers are subject to revision after the full benchmark rerun.}
