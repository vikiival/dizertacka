...
This section covers projects that we consider state-of-the-art in the context of
the Internet of Value. We discuss their goals, strengths, and weaknesses. We can
get inspiration from the good parts and eliminate the parts we consider weak spots.
...
\textbf{Autonolas} offers the most mature and technically robust solution with its
multi-agent architecture and cross-chain capabilities. Its emphasis on fault
tolerance and composability makes it suitable for mission-critical applications.
However, its technical complexity creates a higher barrier to entry for non-specialists.

\textbf{Griffain} prioritizes user experience and practical utility through its natural
language interface and Solana's high-performance infrastructure. While offering
the most accessible entry point for mainstream users, it makes trade-offs in agent
autonomy and decentralization to achieve its simplicity and safety guarantees.
...
Going forward, agentic systems are the natural step forward in interacting with
participants in the Internet of Value. In the next chapter, we will define a new
architecture of AI agents that can incorporate the ownership of Virtuals, the technical
robustness of Autonolas, and the accessibility of Griffain.

Integrating AI agents with blockchain networks opens new frontiers for the
Internet of Value, enabling autonomous value creation, novel ownership models, enhanced
coordination mechanisms, and personalized value management. However, significant
challenges remain in balancing autonomy with safety, addressing regulatory concerns,
and ensuring reliable alignment between off-chain intelligence and on-chain
execution. The following chapter will explore our architectural approach to these
challenges, building on insights from these pioneering projects.
